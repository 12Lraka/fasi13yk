...
export const THEMES: Record<AppSettings['themeColor'], ThemeConfig> = {
  ...
  'midnight-slate': {
    id: 'midnight-slate',
    name: 'Midnight Slate Modern',
    desc: 'Nuansa Minimalis Monokrom & Sky Blue Bersih',
    headerGradient: 'bg-gradient-to-r from-slate-950 via-slate-900 to-zinc-950',
    headerBorder: 'border-slate-800',
    headerSubtext: 'text-slate-300',
    navbarBg: 'bg-slate-950/95',
    navbarBorder: 'border-slate-800',
    navActiveBtn: 'bg-sky-400 text-slate-950 shadow-sky-950/30',
    navInactiveText: 'text-slate-300 hover:text-white hover:bg-slate-900/70',
    navIconActive: 'text-slate-950',
    navIconInactive: 'text-sky-400',
    logoBg: 'bg-slate-900',
    logoBorder: 'border-sky-400/40',
    badgeBg: 'bg-sky-400/20',
    badgeText: 'text-sky-300',
    badgeBorder: 'border-sky-400/30',
    primaryBtn: 'bg-gradient-to-r from-slate-900 to-slate-800 hover:from-slate-800 hover:to-slate-700 text-white border border-slate-700',
    primaryText: 'text-slate-900',
    accentBg: 'bg-slate-100',
    accentBorder: 'border-slate-300',
    accentText: 'text-slate-800',
    selectionClass: 'selection:bg-sky-500 selection:text-slate-950',
  },
  'royal-violet': {
    id: 'royal-violet',
    name: 'Royal Amethyst Violet',
    desc: 'Nuansa Ungu Eksklusif & Emas Lembut',
    headerGradient: 'bg-gradient-to-r from-indigo-950 via-purple-950 to-slate-950',
    headerBorder: 'border-purple-800/60',
    headerSubtext: 'text-purple-200/90',
    navbarBg: 'bg-purple-950/95',
    navbarBorder: 'border-purple-900/80',
    navActiveBtn: 'bg-amber-400 text-slate-950 shadow-purple-950/30',
    navInactiveText: 'text-purple-100/80 hover:text-white hover:bg-purple-900/60',
    navIconActive: 'text-slate-950',
    navIconInactive: 'text-amber-400',
    ...
    badgeText: 'text-amber-300',
    badgeBorder: 'border-amber-400/30',
    primaryBtn: 'bg-gradient-to-r from-purple-800 to-indigo-800 hover:from-purple-700 hover:to-indigo-700 text-white',
